...
const Hero = () => {
  return (
    <section className='w-full h-screen mx-auto'>
      <div
        className={`${styles.paddingX} flex items-center justify-center pt-32 md:pt-[110px] xl:pt-[160px] exl:pt-[400px]`}
      >
            ...
            <div className='lg:mt-20'>
              <div>
                ...
                <p className={`${styles.heroSubText} mt-2 text-white md:py-4`}>
                  I'm a junior software engineer and a computer science graduate from{' '}
